...
def get_loc_temp(u_lat, u_lon):
  ...
  # dataset = nc.Dataset('../../Data/ace_output/autoregressive_predictions.nc', 'r+')

  # temp = dataset['surface_temperature'][0,10,lat_ind,lon_ind]


  dataset = nc.Dataset('../../Data/ace_data/validation/ic_0011/2021010100.nc', 'r+')
...
def update_plot():
  filename = '../../Data/ace_output/autoregressive_predictions.nc'
  ...
  leadtime = 19  # in increments of 6 hours
  #-----------------------------------------
  ...
  plt.tight_layout()
  plt.savefig("../../Data/ace_output/figures/class_5_temps.png", dpi=300, bbox_inches = 'tight')
  # plt.show()
